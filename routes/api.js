...
var creator = 'DaffBotz' // ubah jadi nama lu
const listkey = ["Alphabot","DaffBotz","ZeeoneOfc"]; // ubah apikey nya, tambah aja klo mau
...
router.get('/download/mediafire', async (req, res, next) => {
        ...
        if(listkey.includes(apikey)){
       fetch(encodeURI(`https://api.dapuhy.ga/api/socialmedia/mediafire?url=${url}&apikey=Alphabot`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/download/liriklagu', async (req, res, next) => {
          var apikey = req.query.apikey
       	var url = req.query.url
       	if(!apikey) return res.sendFile(__path + '/docs/403.html')
        if(!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kata"})
        if(listkey.includes(apikey)){
       fetch(encodeURI(`https://api.dapuhy.ga/api/socialmedia/liriklagu?query=${url}&apikey=Alphabot`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/download/twitter', async (req, res, next) => {
        ...
        if(!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kata"})
        if(listkey.includes(apikey)){
       fetch(encodeURI(`https://api.dapuhy.ga/api/socialmedia/twitter?url=${url}&apikey=Alphabot`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/download/cocofun', async (req, res, next) => {
        ...
        if(!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kata"})
        if(listkey.includes(apikey)){
       fetch(encodeURI(`https://docs-jojo.herokuapp.com/api/cocofun-wm?url=${url}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/download/cocofunnowm', async (req, res, next) => {
          var apikey = req.query.apikey
       	var url = req.query.url
       	if(!apikey) return res.sendFile(__path + '/docs/403.html')
        if(!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kata"})
        if(listkey.includes(apikey)){
       fetch(encodeURI(`https://docs-jojo.herokuapp.com/api/cocofun-no-wm?url=${url}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
///OTHER API///
router.get('/other/infogempa', async (req, res, next) => {
          var apikey = req.query.apikey
       	var url = req.query.url
       	if(!apikey) return res.sendFile(__path + '/docs/403.html')
        
        if(listkey.includes(apikey)){
       fetch(encodeURI(`https://api.dapuhy.ga/api/others/infogempa?apikey=Alphabot`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/other/tinyurl', async (req, res, next) => {
        ...
        if(!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kata"})
        if(listkey.includes(apikey)){
       fetch(encodeURI(`https://api.dapuhy.ga/api/others/tinyurl?url=${url}&apikey=Alphabot`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/other/cuttly', async (req, res, next) => {
        ...
        if(!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kata"})
        if(listkey.includes(apikey)){
       fetch(encodeURI(`https://api.dapuhy.ga/api/others/cuttly?url=https://google.com&apikey=Alphabot`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/other/isgd', async (req, res, next) => {
        ...
        if(!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kata"})
        if(listkey.includes(apikey)){
       fetch(encodeURI(`https://api.dapuhy.ga/api/others/isgd?url=${url}&apikey=Alphabot`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/other/styletext', async (req, res, next) => {
          var apikey = req.query.apikey
       	var url = req.query.url
       	if(!apikey) return res.sendFile(__path + '/docs/403.html')
        if(!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kata"})
        if(listkey.includes(apikey)){
       fetch(encodeURI(`https://api.dapuhy.ga/api/others/styletext?text=${url}&apikey=Alphabot`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/other/tokohindo', async (req, res, next) => {
          var apikey = req.query.apikey
       	var url = req.query.url
       	if(!apikey) return res.sendFile(__path + '/docs/403.html')
        
        if(listkey.includes(apikey)){
       fetch(encodeURI(`https://api.dapuhy.ga/api/others/tokohindo?apikey=Alphabot`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/other/heroml', async (req, res, next) => {
          var apikey = req.query.apikey
       	...
       	if(!apikey) return res.sendFile(__path + '/docs/403.html')
        if(!hero) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kata"})
        if(listkey.includes(apikey)){
       fetch(encodeURI(`https://api.dapuhy.ga/api/others/heroml?hero=${hero}&apikey=Alphabot`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/other/jadwaltv', async (req, res, next) => {
          var apikey = req.query.apikey
       	var url = req.query.url
       	if(!apikey) return res.sendFile(__path + '/docs/403.html')
        if(!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kata"})
        if(listkey.includes(apikey)){
       fetch(encodeURI(`https://api.dapuhy.ga/api/others/jadwaltv?channel=${url}&apikey=Alphabot`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
///BATAS OTHER API///
///HILIH VOKAL//
router.get('/hilihvokal/hilih', async (req, res, next) => {
          var apikey = req.query.apikey
       	var url = req.query.url
       	if(!apikey) return res.sendFile(__path + '/docs/403.html')
        if(!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kata"})
        if(listkey.includes(apikey)){
       fetch(encodeURI(`https://api.dapuhy.ga/api/vokal/hilih?kata=${url}&apikey=Alphabot`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/hilihvokal/halah', async (req, res, next) => {
          var apikey = req.query.apikey
       	var url = req.query.url
       	if(!apikey) return res.sendFile(__path + '/docs/403.html')
        if(!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kata"})
        if(listkey.includes(apikey)){
       fetch(encodeURI(`https://api.dapuhy.ga/api/vokal/halah?kata=${url}&apikey=Alphabot`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/hilihvokal/holoh', async (req, res, next) => {
          var apikey = req.query.apikey
       	var url = req.query.url
       	if(!apikey) return res.sendFile(__path + '/docs/403.html')
        if(!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kata"})
        if(listkey.includes(apikey)){
       fetch(encodeURI(`https://api.dapuhy.ga/api/vokal/holoh?kata=${url}&apikey=Alphabot`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/hilihvokal/heleh', async (req, res, next) => {
          var apikey = req.query.apikey
       	var url = req.query.url
       	if(!apikey) return res.sendFile(__path + '/docs/403.html')
        if(!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kata"})
        if(listkey.includes(apikey)){
       fetch(encodeURI(`https://api.dapuhy.ga/api/vokal/heleh?kata=${url}&apikey=Alphabot`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/hilihvokal/huluh', async (req, res, next) => {
          var apikey = req.query.apikey
       	var url = req.query.url
       	if(!apikey) return res.sendFile(__path + '/docs/403.html')
        if(!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kata"})
        if(listkey.includes(apikey)){
       fetch(encodeURI(`https://api.dapuhy.ga/api/vokal/huluh?kata=${url}&apikey=Alphabot`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
